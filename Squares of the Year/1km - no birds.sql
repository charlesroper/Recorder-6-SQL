...
if object_ID('NBNReporting.dbo._temp_SOTY_no_birds') is not null
	drop table NBNReporting.dbo._temp_SOTY_no_birds;
...
select distinct --top 100
	...
	,taxon_group_name
into
	NBNReporting.dbo._temp_SOTY_no_birds
from
	sample sa
inner join
...
alter table _temp_SOTY_no_birds
