SELECT DISTINCT
      ...
      ITNS1.COMMON_NAME         AS [Common Designated As],
      ITNS1.PREFERRED_NAME      AS [Latin Designated As],
      ITNS3.COMMON_NAME         AS [Common Synonym],
      ITNS3.PREFERRED_NAME      AS [Latin Synonym],
...
WHERE --TXG.TAXON_GROUP_NAME = 'terrestrial mammal'
ITNS1.PREFERRED_NAME = 'meles meles'
ORDER BY [Latin Designated As]
