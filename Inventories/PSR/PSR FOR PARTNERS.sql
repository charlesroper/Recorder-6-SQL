...
IF object_ID('NBNReporting.dbo._tempPSR') IS NOT NULL
	DROP TABLE NBNReporting.dbo._tempPSR
...
WHERE
	TXOD.MEASUREMENT_QUALIFIER_KEY = 'THU00002000000A9' AND
	TXOD.DATA = 'Yes' AND
