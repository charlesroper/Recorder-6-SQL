...
begin transaction
	...
	set @taxon_list_item_key = 'NHMSYS0000332594'
	...
	set @comment = '[CONFIDENTIAL: All Wood White records have been made confidential in the SxBRC database in line with Butterfly Conservation''s request to do so. March 2012.]'

	-- Duke of Burgundy
	set @taxon_list_item_key	= 'NHMSYS0000497817'
	set @comment = '[CONFIDENTIAL: All Duke of Burgundy records have been made confidential in the SxBRC database in line with Butterfly Conservation''s request to do so. March 2012.]'
