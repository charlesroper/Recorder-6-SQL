...
begin transaction
  ...
  set @comment = '[CONFIDENTIAL: All Duke of Burgundy records have been made confidential in the SxBRC database in line with Butterfly Conservation''s request to do so. October 2012.]'
