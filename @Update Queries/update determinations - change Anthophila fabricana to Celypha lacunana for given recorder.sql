...
/*
Re-determine all Anthophila fabricana by Ivan Lang to Celypha lacunana.
=======================================================================
...
Re-determine all Anthophila fabricana by Ivan Lang to Celypha lacunana.
    ...
    * Determiner: Ivan Lang
    * Comment: "Anthophila fabricana was originally entered in error; changed to Celypha lacunana."
...
begin transaction
    ...
    set @date                   = GETDATE()
    set @new_determiner         = 'EG00003300000003' -- Ivan Lang
    ...
    set @old_taxon              = 'NHMSYS0000495417' -- Anthophila fabricana
    set @new_taxon              = 'NHMSYS0000496094' -- Celypha lacunana
    set @determination_comment  = 'Anthophila fabricana was originally entered in error; changed to Celypha lacunana.'
    set @recorder               = '%ivan lang%'
